...
def mapBackground(bg, minlon, maxlon, minlat, maxlat, pad, zoomLevel, title, img=None,vmin=None,vmax=None, scalebar=100, borders=True,plotFaults=True):
    ...
    if not vmin==None:
        ...
        ax.imshow(img,vmin=vmin,vmax=vmax,cmap='RdBu_r', origin='upper', transform=ccrs.PlateCarree(), extent=[minlon, maxlon, minlat, maxlat],zorder=4)
